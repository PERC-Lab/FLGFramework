...
/****** Object:  View [dbo].[View_3]    Script Date: 6/16/2018 12:17:28 PM ******/
SET ANSI_NULLS ON
GO
...
AS
SELECT        'Connection' + ConID AS '@name', '' AS '@description', ElementID_1 AS '@srcid', ElementID_2 AS '@destid'
FROM            dbo.Table_Connection
FOR XML PATH  ('decomposition')
GO
